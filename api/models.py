...
class Product(models.Model):
    ...
    date_listed = models.DateTimeField(max_length=225, default=datetime.now().replace(microsecond=0, second=0, minute=0))
    product_weight = models.FloatField(validators=[MinValueValidator(0.1)], default=0.1)
    product_height = models.FloatField(validators=[MinValueValidator(0)], default=1.0)
    product_width = models.FloatField(validators=[MinValueValidator(0)], default=1.0)
